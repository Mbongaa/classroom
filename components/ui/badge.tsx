  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[#b8b2b2] focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        meeting:
          "border-transparent bg-blue-500 text-white dark:bg-blue-600 dark:text-white",
        classroom:
          "border-transparent bg-green-500 text-white dark:bg-green-600 dark:text-white",
        speech:
          "border-transparent bg-purple-500 text-white dark:bg-purple-600 dark:text-white",
      },
    },
    defaultVariants: {
      variant: "default",
