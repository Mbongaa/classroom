...
import styles from './SpeechRequestIndicator.module.css';
...
function SpeechRequestIndicator({
  request,
  participantName,
  isTeacher,
  onQuestionDisplay
...
export default React.memo(SpeechRequestIndicator, (prevProps, nextProps) => {
  return (
